  ...
  const diaryFeatures = [
    {
      ...
      description: "Documenta facilmente ogni attività svolta in campo con pochi clic",
      icon: "📝"
    },
    {
      title: "Conformità legislativa",
      description: "Rispetta automaticamente tutte le normative senza stress burocratico",
      icon: "✅"
    },
    {
    ...
    },
    {
      ...
      description: "Usa l'app in campo, anche offline, su qualsiasi dispositivo",
      icon: "📱"
    },
    {
      title: "Integrazione completa",
      description: "Connetti sensori, previsioni meteo e altri strumenti smart farming",
      icon: "🔄"
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 md:pr-10">
              <motion.h1 
                ...
                variants={fadeInUp}
              >
                Il Quaderno di Campagna <span className="text-green-600">Digitale</span> che Rivoluziona la tua Azienda
              </motion.h1>
            ...
            >
              <div className="relative">
                ...
                >
                  <Image
                    src="/quaderno-campagna-demo.jpg" // You'll need to create this image
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-gray-600 text-sm">5.0 - 230+ agricoltori soddisfatti</span>
                    </div>
                  </div>
                </motion.div>
              </div>
      ...
      <div className="relative h-24 overflow-hidden">
        <svg viewBox="0 0 500 150" preserveAspectRatio="none" className="absolute bottom-0 w-full h-full">
          <path d="M0.00,49.98 C150.00,150.00 350.00,0.00 500.00,49.98 L500.00,150.00 L0.00,150.00 Z" className="fill-green-50"></path>
        </svg>
      </div>
      ...
      <section className="py-20 bg-green-100/50 relative" ref={featuresRef}>
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Molto più di un Quaderno di Campagna</h2>
            <p className="text-xl text-gray-700">Trasforma gli obblighi burocratici in opportunità per migliorare la tua azienda agricola.</p>
          </motion.div>
          ...
          >
            <div className="bg-black aspect-video flex items-center justify-center text-white text-center p-12">
              <div>
                <p className="text-2xl mb-6">Video dimostrativo del Quaderno di Campagna digitale</p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Come Funziona</h2>
            <p className="text-xl text-gray-700">Gestione semplice e completa del tuo Quaderno di Campagna in pochi semplici passi.</p>
          </motion.div>
              ...
              {[
                {
                  ...
                  description: "Documenta facilmente trattamenti, semine, concimazioni e altre operazioni dal tuo smartphone o computer, anche offline.",
                  image: "/register-activities.jpg", // You'll need this image
                  isReversed: false
                },
                {
                  title: "Rispetta normative e scadenze",
                  description: "Il sistema ti avvisa automaticamente di tempi di carenza, intervalli tra trattamenti e tutte le scadenze importanti.",
                  image: "/compliance.jpg", // You'll need this image
                  isReversed: true
                },
                {
                  title: "Analizza e migliora",
                  description: "Visualizza statistiche dettagliate e ottieni suggerimenti personalizzati per migliorare la sostenibilità e la redditività.",
                ...
                >
                  <div className="md:w-1/2 mb-6 md:mb-0">
                    <div className="relative">
                      <div className={`hidden md:flex absolute top-1/2 ${step.isReversed ? 'right-0 translate-x-1/2' : 'left-0 -translate-x-1/2'} transform -translate-y-1/2 w-12 h-12 bg-green-500 text-white rounded-full items-center justify-center text-xl font-bold z-10`}>
                        {index + 1}
                      </div>
                  ...
                  <div className={`md:w-1/2 ${step.isReversed ? 'md:pr-12' : 'md:pl-12'}`}>
                    <h3 className="text-2xl font-bold text-green-700 mb-4">{step.title}</h3>
      ...
      <section className="py-20 bg-green-50" ref={testimonialsRef}>
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Chi usa già AgroKe</h2>
            <p className="text-xl text-gray-700">Ascolta le testimonianze di chi ha già trasformato la propria azienda agricola.</p>
          </motion.div>
          ...
          >
            {[
              {
                quote: "Da quando uso il Quaderno di Campagna digitale di AgroKe, ho ridotto di 4 ore la settimana il tempo dedicato alla burocrazia. Ora posso concentrarmi di più sul campo.",
                name: "Marco Bianchi",
                role: "Viticoltore, Toscana",
                image: "/testimonial1.jpg" // You'll need this image
              },
              {
                quote: "Ho evitato due sanzioni grazie agli avvisi automatici. Il sistema mi ricorda tutte le scadenze e i tempi di carenza, non sbaglio più!",
                name: "Lucia Romano",
                role: "Produttrice biologica, Puglia",
                image: "/testimonial2.jpg" // You'll need this image
              },
              {
                quote: "Finalmente ho dati chiari su tutti i trattamenti. Ho scoperto che potevo risparmiare il 20% sui prodotti fitosanitari senza compromettere i risultati.",
                name: "Giovanni Russo",
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex flex-col md:flex-row bg-white rounded-2xl shadow-2xl overflow-hidden">
            <motion.div 
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-3xl font-bold mb-6">Inizia ora la trasformazione digitale della tua azienda agricola</h2>
              <p className="mb-8 text-green-100">Lascia i tuoi dati per ricevere una demo personalizzata del nostro Quaderno di Campagna digitale.</p>
              ...
              <div className="p-6 bg-green-700 rounded-xl">
                ...
                <p className="text-sm text-green-200 mb-4">Il nostro team è disponibile per guidarti in ogni fase.</p>
                <a href="tel:+390123456789" className="flex items-center text-white hover:text-green-200 transition-colors">
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8 }}
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-6">Richiedi una Demo Gratuita</h3>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Ettari Coltivati</label>
                  <input
                    type="number"
                    value={ettari}
